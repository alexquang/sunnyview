...
class CreateInvoicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('aws_usage_account_id')->nullable()->comment('costacctid');
            $table->string('aws_usage_account_name')->nullable()->comment('costacctname');
            $table->unsignedBigInteger('aws_reseller_accounts_id')->nullable()->comment('parentacctid');
